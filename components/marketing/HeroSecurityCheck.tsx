                  ...
                  {result.vulnerable ? (
                    <div className="mt-5 p-4 rounded-2xl border border-cyan-900 bg-gradient-to-br from-cyan-950/30 to-blue-950/20">
                      ...
                      <div className="flex flex-col sm:flex-row gap-3">
                        ...
                        <BuyButton product="incident" label="Incident Kit Pro (Stripe)" className="px-5 py-3 rounded-2xl font-black bg-gradient-to-r from-orange-500 to-red-600 hover:opacity-90" />
                    ...
                    <div className="mt-5 p-4 rounded-2xl border border-gray-800 bg-black/20">
                      ...
                      <div className="flex flex-col sm:flex-row gap-3">
                        ...
                        <BuyButton product="sprint" label="Sprint Pack kaufen (Stripe)" className="px-5 py-3 rounded-2xl font-black bg-gradient-to-r from-brand-cyan to-brand-violet hover:opacity-90" />
                      </div>
                    </div>
                  )}
                </div>
